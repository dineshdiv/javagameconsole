...
export const Navbar = () => {
 ...
 <div className="logoimg"><img src="codelogo.png" alt="" /></div>
     ...
     <h3 className="nav-Link"> <Link to={"/"}>Exception Handling</Link></h3>
     <h3 className="nav-Link"> <Link to={"/Component2"}>Multithreading</Link></h3>
     <h3 className="nav-Link"> <Link to={"/Component3"}>Prototype Inheritance</Link></h3>
     <h3 className="nav-Link"> <Link to={"/Component4"}>Asynchronous programming</Link></h3>
